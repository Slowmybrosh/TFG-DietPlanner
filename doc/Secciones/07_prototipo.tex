...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=100mm,scale=1]{./doc/imagenes/home-ipad-horizontal.png}}
...
\begin{figure}[b!p]
\centering
\fbox{\includegraphics[width=63mm,scale=1]{./doc/imagenes/home-vertical.png}}
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=100mm,scale=1]{./doc/imagenes/buscador-tabla.png}}
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=120mm,scale=1]{./doc/imagenes/resultados-guardadas.png}}
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=75mm,scale=1]{imagenes/resultados-ipad.png}}
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=75mm,scale=1]{./doc/imagenes/receta-ipad.png}}
