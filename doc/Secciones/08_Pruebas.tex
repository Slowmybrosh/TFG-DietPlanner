...
En el desarrollo de las pruebas se ha realizado con la herramienta pytest, incluida en django. Se ha generado un \gls{test} para cada filtro de la base de datos.
\begin{enumerate}
    \item Recetas
    \begin{itemize}
        \item Identificador
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=125mm, scale=1]{./doc/imagenes/home-escritorio.png}}
    \fbox{\includegraphics[width=125mm, scale=1]{./doc/imagenes/Receta-Daniel.png}}
    \caption{Primeros pasos de Daniel}
    \label{fig:Daniel-pasos1}
\end{figure}

Una vez que vuelve a la página principal, empieza a introducir los ingredientes que quiere gastar. Como últimamente quiere comer sano, le apetece cenar una ensalada gastando las verduras que están a punto de caducar y añadiendo otros ingredientes que le sobran.
\begin{enumerate}
    \item Bacalao
    \item Huevos
    \item Espinacas
...
El buscador debería encontrar las recetas que usan estos ingredientes, mostrándolas al usuario de manera organizada y clara. Las recetas que se deben ofrecer son:
\begin{enumerate}
...
Daniel mira los resultados devueltos y elige comer una ensalada de lentejas, seleccionando dicha receta desde el buscador, leyendo la receta y reuniendo los ingredientes. 
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=120mm, scale=1]{./doc/imagenes/Resultados-Daniel.png}}
    \fbox{\includegraphics[width=120mm, scale=1]{./doc/imagenes/recetafinal-daniel.png}}
...
\begin{figure}[H]
    \fbox{\includegraphics[width=120mm, scale=1]{./doc/imagenes/Resultados-Marien.png}}
