...
Se escoge PostgreSQL sobre MySQL por permitir una mayor concurrencia, permitiendo a más usuarios obtener recetas al mismo tiempo. PostgreSQL además supera en velocidad de lectura y escritura con consultas complicadas. Es más difícil de configurar, pero merecen la pena las ventajas que otorga sobre consultas complejas. \cite{bbdd2023}
