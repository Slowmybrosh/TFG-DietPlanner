...
En la experiencia, \Gls{flask} ha sido más difícil de configurar ya que se encontró menos documentación para los fallos surgidos. No tiene soporte para aplicaciones multipágina, carece de una capa de seguridad incluida y no permite multiplataforma de manera nativa.
