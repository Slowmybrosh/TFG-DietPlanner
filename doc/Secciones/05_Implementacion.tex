...
\section{Herrramienta desacoplar la \gls{base}}
...
Se utiliza SQLAlchemy por ser una herramienta con un uso sencillo, aunque con una curva de aprendizaje elevada, para el proyecto no se necesitan consultas demasiado complejas. SQLAlchemy es compatible con multitud de conectores de bases de datos, encontrandose SQLite entre ellos y su compatibilidad con \emph{frameworks} web de \gls{python} \cite{orm2023}
