...
Se escoge PostgreSQL sobre MySQL por permitir una mayor concurrencia, permitiendo a más usuarios obtener recetas al mismo tiempo. Postgre además supera en velocidad de lectura y escritura con consultas complicadas. Es más dificil de configurar, pero merecen la pena las ventajas que otorga sobre consultas complejas. \cite{bbdd2023}

Para realizar la conexión de la base de datos con \Gls{python}, se utilizará la biblioteca ``pyscopg2'' que permite la conexión eficiente entre ambos servicios.