...
En este proyecto se utiliza una metodología ágil, en resumidas cuentas es un conjunto de técnicas aplicadas en ciclos cortos de trabajo para que la entrega de un proyecto sea más eficiente. En las etapas completadas, se pueden entregar avances dejando a un lado la necesidad de terminar el proyecto completamente. \cite{metodologia}

En primer lugar, es esencial identificar el problema que tienen los usuarios y que se va a resolver en el proyecto. Para ello se debe asumir el rol de usuario e identificar que posibles problemas pueden tener solución. En este caso, se solventará el problema del usuario de cocinar utilizando una serie de ingredientes concretos sin conocer una receta que involucre dichos ingredientes. La solución, como se desarrolló en secciones anteriores permitirá al usuario encontrar recetas utilizando los ingredientes de su elección. 

Por otro lado, se deben especificar los usuarios a los que va dirigida la solución. Se perfilarán dichos usuarios detallando su entorno, conocimientos, motivaciones, etc... Estos usuarios serán el centro del desarrollo, basandonos en sus necesidades irán surgiendo nuevos objetivos que alcanzar. 

En el contexto de la metodología ágil se utilizan ``milestones'' o hitos para resaltar puntos clave en el desarrollo del proyecto, que sirven para medir el desarrollo del proyecto y evaluar que se cumplan los objetivos. \cite{hitos}

El primer \gls{milestone} especificado constituye permitir al usuario encontrar recetas con ciertas restricciones, para ello se establecerán pequeños subobjetivos para alcanzar el milestone y se resolverán cuestiones relativas al objetivo, por ejemplo, que se entiende como ingrediente o receta. Se desestimarán las consideraciones que no avancen el objetivo de cubrir la necesidad del usuario hasta que se complete el milestone relativo a encontrar recetas.