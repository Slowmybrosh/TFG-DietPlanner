...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=100mm,scale=1]{./doc/imagenes/Desktop.png}}
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=100mm,scale=1]{./doc/imagenes/SurfacePro8.png}}
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=65mm,scale=1]{./doc/imagenes/iPadPro11.png}}
...
Inicialmente, se especifican los \emph{\glspl{milestone}} mencionados, pero debido a la mentalidad ágil es imposible planificar \emph{\glspl{milestone}} más allá, porque no se sabe que necesidades tendrá el usuario a lo largo del desarrollo del proyecto o que nuevos problemas se pueden plantear y por tanto se especificarán en la sección implementación

Después de completar la implementación de la funcionalidad para encontrar recetas, el siguiente paso a dar es analizar el despliegue para que el usuario acceda a la aplicación estando cómodamente sentado en el sofá de su casa. 

\subsection{Milestones}
Para resumir, la lista de \emph{\glspl{milestone}} iniciales mencionados anteriormente son los siguientes\:
\begin{enumerate}
    ...
    \item \href{https://github.com/Slowmybrosh/TFG-DietPlanner/milestone/14}{Análisis del despliegue}
\end{enumerate}