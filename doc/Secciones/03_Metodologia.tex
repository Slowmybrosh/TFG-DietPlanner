...
Normalmente en un proyecto se suele especificar una planificación de antemano que cubrir, pero como se ha explicado en este capítulo, se usará una mentalidad ágil para el desarrollo del mismo. Esto significa que no se sabe a largo plazo que objetivos se van a cumplir, ya que solo se puede planificar como mucho un objetivo o dos por delante. Pero hasta que no se llega al final de un objetivo no se puede saber realmente por donde se va a seguir avanzando, todo esto lo dicta la metodología que se sigue en el proyecto.
