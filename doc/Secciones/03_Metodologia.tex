...
En el contexto del desarrollo ágil se utilizan \gls{milestones} o hitos para resaltar puntos clave en el desarrollo del proyecto, que sirven para medir el desarrollo del proyecto y evaluar que se cumplan los objetivos. \cite{hitos}
