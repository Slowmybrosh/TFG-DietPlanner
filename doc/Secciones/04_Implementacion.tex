...
Con lo cual, el lenguaje utilizado en el desarrollo del proyecto será \Gls{python}, ya que tengo conocimientos de este lenguaje. Facilitando el desarrollo del proyecto y el uso de buenas prácticas. 
