...
\input{Secciones/06_Fuente_recetas}
\input{Secciones/07_prototipo}
\input{Secciones/08_Pruebas}
\input{Secciones/09_despliegue}
\input{Secciones/10_costes}
...
%
\appendix
\input{apendices/12_Anexo_BD}
\input{apendices/13_Anexo_prototipo}
\input{apendices/14_Anexo_pruebas}
